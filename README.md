...
Sound quality is intentionally "good enough to validate an idea". The goal is fast creative iteration, not a polished render.

*Fast Tracker 2 (1994) — A respected example to follow.*
![Fast Tracker 2 — the spiritual ancestor](ft2-screenshot.png)
